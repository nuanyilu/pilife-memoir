<template>
  <div class="chat-page">
    <div class="chat-header">
      <span class="chat-title">💬 暖暖倾诉</span>
    </div>
    <div class="msg-list" ref="msgRef">
      ...
      <el-empty v-if="!messages.length" description="开始和暖暖聊天吧 💛" />
    </div>
...
import { chat, chatHistory } from '../../api'
...
.chat-header { background: linear-gradient(135deg,#d4a574,#c4956a); color: #fff; padding: 12px 16px; text-align: center; font-size: 16px; font-weight: 600; }
...
.msg-row.user .msg-bubble { background: #d4a574; color: #fff; border-bottom-right-radius: 4px; }
